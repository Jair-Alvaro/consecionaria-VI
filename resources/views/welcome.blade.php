...
<body>
    ...
    <!-- <header>
        ...
        <!-- Este es el que se muestra despues de logearse -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <ul class="navbar-nav me-auto mb-2 mb-md-0">
                            ...
                            @else
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ url('/misCarros') }}">MIS CARROS</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('home') }}">CATALOGO</a>
                            </li>
                ...
                <div class="carousel-item">
                    ...
                    <div class="container" >
                        <div class="carousel-caption" id="dato">
                            <h1>Clasicos</h1>
                            <br>
                            <p><a class="btn btn-lg btn-primary" id = "boton" href="{{ route('home') }}">Galeria</a></p>
                        </div>
                    </div>
                </div>
            </div>
