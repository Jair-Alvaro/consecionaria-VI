        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <p class="lead text-muted">Cuando tienes habilidades para conducir, solo tienes que ponerlas a prueba. Compra un auto que combine su apariencia con tus habilidades y que ese diseñado para conducir de manera segura.</p>
                </div>
            </div>
        </section>
                        ...
                        <img class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" src="mostrarImagenAuto/{{$auto->rutafoto}}" preserveAspectRatio="xMidYMid slice" focusable="false">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="collapse"  data-bs-target="#collapseExample{{$auto->id}}" id="mostrar" onclick="mostrar();">Caracteristicas</button>
                                        <button type="button" class="btn btn-sm btn-outline-secondary"><a href="{{ url('/compra') }}">Comprar</a></button>                
                                    </div>
                                </div>
